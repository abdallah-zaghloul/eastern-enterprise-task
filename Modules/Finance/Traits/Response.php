...
use Modules\Finance\Enums\HttpStatusCodeEnum;
...
trait Response
{
    ...
    ): mixed
    {
        $response = response()->json(
            data: [
                'status' => false,
                'message' => $message ?? @trans('finance::messages.bad_request'),
                'errors' => $errors,
            ],
    ...
    ): JsonResponse
    {
        return response()->json(
            data: [
                'status' => true,
                'message' => $message ?? @trans('finance::messages.success'),
            ],
    ...
    ): mixed
    {
        $response = response()->json(
            data: [
                'status' => false,
                'message' => $message ?? @trans('finance::messages.unavailable_server'),
            ],
